...
class GStatement(object):
    ...
    def __len__(self):
        return self.codes.__len__()

    def __getitem__(self, key):
        return self.codes.__getitem__(key)

    def __setitem__(self, key, value):
        return self.codes.__setitem__(key, value)

    def __delitem__(self, key):
        return self.codes.__delitem__(key)
    ...
    def clone(self):
        codes = [code.clone() for code in self.codes]
        return GStatement(*codes)
...
class GCode(object):
    ...
    def __str__(self):
        ...
        def clone(self):
            return GCode(self.address, self.command, self.precision)
